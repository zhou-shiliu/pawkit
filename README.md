...
一个轻量的桌面宠物陪伴应用，兼容 Codex Pet 风格宠物包。把喜欢的小宠物放在桌面上，让它安静陪你工作、移动、发呆，并在需要时给一点点可爱的回应。

> 定位：Codex Pet 兼容的桌面宠物陪伴
...
Pawkit 不想成为一个“宠物播放器”，更像桌面上的一个小陪伴：它有存在感，但不抢走你的注意力。
...
如果你只是想使用 Pawkit，不需要下载源码。最新版本以 GitHub Releases 为准，可以直接下载对应系统的安装包：
